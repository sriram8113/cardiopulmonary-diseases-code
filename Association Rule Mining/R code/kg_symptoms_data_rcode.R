...
#sorting with respect to confidence , lift and support
SortedRules_confi <- sort(Srules1, by="confidence", decreasing=TRUE)
SortedRules_lift<- sort(Srules1, by="confidence", decreasing=TRUE)
SortedRules_supp <- sort(Srules1, by="confidence", decreasing=TRUE)
...
#sorting with respect to confidence , lift and support
havingchestpainRules_confi <- sort(havingchestpainRules, decreasing=TRUE, by="confidence")
havingchestpainRules_lift <- sort(havingchestpainRules, decreasing=TRUE, by="lift")
havingchestpainRules_supp <- sort(havingchestpainRules, decreasing=TRUE, by="support")

#inspecting top 20 rules 
inspect(havingchestpainRules_confi[1:20])
inspect(havingchestpainRules_lift[1:20])
inspect(havingchestpainRules_supp[1:20])
...
#sorting with respect to confidence , lift and support
breathlessnessRules_confi <- sort(breathlessnessRules, decreasing=TRUE, by="confidence")
breathlessnessRules_lift <- sort(breathlessnessRules, decreasing=TRUE, by="lift")
breathlessnessRules_supp <- sort(breathlessnessRules, decreasing=TRUE, by="support")
#inspecting top 20 rules 
inspect(breathlessnessRules_confi[1:20])
inspect(breathlessnessRules_lift[1:20])
inspect(breathlessnessRules_supp[1:20])
#plotting
...
#sorting with respect to confidence , lift and support
fast_heart_rate_Rules_confi <- sort(fast_heart_rate_Rules, decreasing=TRUE, by="confidence")
fast_heart_rate_Rules_lift <- sort(fast_heart_rate_Rules, decreasing=TRUE, by="lift")
fast_heart_rate_Rules_supp <- sort(fast_heart_rate_Rules, decreasing=TRUE, by="support")

#inspecting top 20 rules 
inspect(fast_heart_rate_Rules_confi[1:20])
inspect(fast_heart_rate_Rules_lift[1:20])
inspect(fast_heart_rate_Rules_supp[1:20])
